...
export const colors = stylex.defineVars({
  ...
  textPlaceholder: `color-mix(in srgb, ${slateDark.slate11} 80%, transparent)`,
  ...
  capabilityImage: "oklch(76% 0.125 245)",
  capabilityVideo: "oklch(76% 0.14 315)",
  capabilityAudio: "oklch(78% 0.13 175)",
  capabilityReasoning: "oklch(80% 0.14 75)",
